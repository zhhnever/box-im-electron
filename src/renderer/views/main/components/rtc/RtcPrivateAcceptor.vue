<template>
  <div class="rtc-private-acceptor">
    ...
    <div class="acceptor-text">{{tip}}</div>
    ...
    .icon {
      ...
      &.accept {
        ...
        @keyframes anim {
          ...
          25% {
            box-shadow: 0 1px 0 12px rgba(255, 210, 128, 1),
              0 1px 0 16px rgba(255, 201, 102, 1);
          }

          50% {
            box-shadow: 0 2px 5px 10px rgba(255, 184, 51, 1),
              0 2px 5px 23px rgba(248, 248, 255, 1);
          }
        }

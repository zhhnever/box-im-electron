...
export class IpcChannelMainClass {
  ...
  ResizeMainWindow: IpcMainEventListener<{
    w: number;
    h: number;
  }> = null;
  OpenFileDialog: IpcMainEventListener<{
    fileTypes: Array<string>;
  }, Array<any>> = null;
  uploadFile: IpcMainEventListener<{
    files: Array<any>; token: string; url: string
  }, void | Promise<Array<any>>> = null;
}
